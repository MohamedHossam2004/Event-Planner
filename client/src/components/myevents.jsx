          ...
          {events.map((event) => (
            <div style={styles.eventCard} key={event._id}>
              <div style={styles.eventHeader}>
                ...
                <p style={styles.eventDate}>{new Date(event.date).toLocaleDateString()}</p>
              </div>
                ...
                <ul>
                  {event.organizers.map((organizer, index) => (
                    <li key={index} style={styles.organizerItem}>
                      <p><strong>{organizer.name}</strong> - {organizer.role}</p>
              ...
              <div style={styles.eventUshers}>
               
              </div>
              <div style={styles.eventCapacity}>
                <p><strong>Capacity:</strong> {event.min_capacity} - {event.max_capacity}</p>
              </div>
            </div>
          ))}
        </div>
